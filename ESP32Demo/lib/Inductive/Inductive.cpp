...
// int servoPin = 14; // 舵机的信号口连接到ESP32的GPIO14
Inductive::Inductive(int trigPin, int echoPin, int servoPin) {
    this->trigPin = trigPin;
    this->echoPin = echoPin;
    this->servoPin = servoPin;
}

void Inductive::rotateServo(int targetAngle)
{
